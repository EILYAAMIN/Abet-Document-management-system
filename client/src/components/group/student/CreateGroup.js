...
import { createGroup } from '../../../appRedux/actions/group';
import { getCreatedGroup } from '../../../appRedux/actions/group';
import { deleteGroup } from '../../../appRedux/actions/group';
import Spinner from '../../layout/Spinner';


const CreateGroup = ({ getTopicsPUB, searchStudents, createGroup, isAuthenticated,
    ...
    const addMember = e => {
        e.preventDefault();
        if (!members.includes(e.target.value) && members.length <= 3) {
    ...
    const createGp = async () => {
        ...
        await createGroup(topic, members);
        await getCreatedGroup();
    }
            ...
            {!isAuthenticated ? null :
                <Fragment>
                    <div className="creategp">
                        ...
                        <button className="btn-primary" onClick={() => createGp()}>Create</button>
                    </div>
                    <div>
                        <div className="container">
                            <div className="table">
...
export default connect(
    mapStateToProps,
    { getTopicsPUB, searchStudents, createGroup, getCreatedGroup, deleteGroup }
)(CreateGroup);
